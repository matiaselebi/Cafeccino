...
namespace BLL
{
    public class BLLEvento
    {
        ...
        public Dictionary<string, string> CrearDiccionarioTraducido()
        {
            ...
            dict.Add("Productos", LanguageManager.ObtenerInstancia().ObtenerTexto("Modulos.Productos"));
            ...
            dict.Add("Registro de producto", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RegistroProducto"));
            dict.Add("Modificación de producto", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ModificacionProducto"));
            dict.Add("Borrado lógico de producto", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.BorradoProducto"));
            dict.Add("Restauración de producto", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RestauracionProducto"));
            dict.Add("Actualización de estado de producto", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ActualizacionEstadoProducto"));
            dict.Add("Consulta de productos", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ConsultaProductos"));
            ...
            dict.Add("Recepción de compras", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RecepcionCompras"));
            ...
            dict.Add("Generación de reporte de recepción de compras", LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ReporteRecepcion"));
        ...
        public DataTable ObtenerModulos()
        {
            ...
            dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Modulos.Productos"), "Productos");
        ...
        public DataTable ObtenerEventos(string Modulo)
        {
            ...
            switch (Modulo)
            {
                ...
                case "Productos":
                    dt.Rows.Add("", "");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RegistroProducto"), "Registro de producto");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ModificacionProducto"), "Modificación de producto");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.BorradoProducto"), "Borrado lógico de producto");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RestauracionProducto"), "Restauración de producto");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ActualizacionEstadoProducto"), "Actualización de estado de producto");
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.ConsultaProductos"), "Consulta de productos");
                    break;
                case "Clientes":
                    dt.Rows.Add("", "");
                ...
                case "Compras":
                    ...
                    dt.Rows.Add(LanguageManager.ObtenerInstancia().ObtenerTexto("Eventos.RecepcionCompras"), "Recepción de compras");
