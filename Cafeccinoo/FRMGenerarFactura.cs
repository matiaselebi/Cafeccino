...
namespace Cafeccinoo
{
    public partial class FRMGenerarFactura : Form, IObserver
    {
        ...
        {
            parent = this.MdiParent as FRMUI;
            LanguageManager.ObtenerInstancia().CargarIdioma(); // Cargar el idioma antes de actualizar
            ActualizarIdioma(); // Actualizar los textos de los controles
        }
        ...
        void VaciarCampos()
        {
            ...
            parent.FormSeleccionarProductos.label5.Text = "0";
            ...
            try
            {
                ...
                parent.FormSeleccionarProductos.dataGridView2.Rows.Clear();
            }
            catch (Exception) { }
        ...
        void GenerarReportePDF()
        {
            ...
            DataTable ProductosVenta = negocios.ObtenerTabla("Producto.CodProducto, Nombre, Tipo, Precio, Cantidad", "Producto INNER JOIN Item ON Producto.CodProducto = Item.CodProducto", $"CodFactura = {NegociosFactura.ObtenerCodFactura()}");
