...
namespace Cafeccinoo
{
    public partial class FRMSolicitudCotizacion : Form, IObserver
    {
        ...
        private void FRMSolicitudCotizacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void BTNGenerarSolicitud_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    sol.Items.Add(new ItemSolicitud(Convert.ToInt32(dr.Cells[0].Value.ToString()), CodSol));
                }
        ...
        {
            DataTable dt = negocios.ObtenerTabla("CodProducto, Tipo, Nombre, Stock, MaxStock, MinStock", "Producto", "Stock < MinStock AND Activo = 1");
        ...
        {
            DataTable dt = negocios.ObtenerTabla("CodProducto, Tipo, Nombre, Stock, MaxStock, MinStock", "Producto", $"Activo = 1 AND Stock < MinStock AND CodProducto LIKE '{textBox1.Text}%'");
            dt = TraducirTablaProductos(dt);
            dataGridView1.DataSource = dt;
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                foreach (var item in listBox1.Items)
                {
                    ...
                    {
                        MessageBox.Show(LanguageManager.ObtenerInstancia().ObtenerTexto("FRMSolicitudCotizacion.Etiquetas.ProductoYaSeleccionado"));
        ...
        {
            DataTable ProductosSolicitud = negocios.ObtenerTabla("Producto.CodProducto, Tipo, Nombre", "Producto INNER JOIN ItemSolicitud ON Producto.CodProducto = ItemSolicitud.CodProducto", $"CodSolicitud = {NegociosSolicitud.ObtenerCodSolicitudCotizacion()}");
