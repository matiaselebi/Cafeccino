...
namespace Cafeccinoo
{
    public partial class FRMGenerarReporteFactura : Form, IObserver
    {
        ...
        private void BTNGenerarReporte_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable ProductosVenta = negocios.ObtenerTabla("Producto.CodProducto, Nombre, Tipo, Precio, Cantidad", "Producto INNER JOIN Item ON Producto.CodProducto = Item.CodProducto", $"CodFactura = {dataGridView1.Rows[dataGridView1.CurrentCell.RowIndex].Cells[0].Value}");
