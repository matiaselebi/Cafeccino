...
namespace Cafeccinoo
{
    public partial class FRMCobrarVenta : Form, IObserver
    {
        ...
        private void FRMCobrarVenta_FormClosing_1(object sender, FormClosingEventArgs e)
        {
        ...
        private void FRMCobrarVenta_VisibleChanged_1(object sender, EventArgs e)
        {
            VaciarCampos();
        }
        ...
        private void BTNCobrarVenta_Click_1(object sender, EventArgs e)
        {
            try
            {
