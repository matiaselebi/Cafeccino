...
namespace Servicio
{
    public class ReportesPDF
    {
        public static void ReporteVenta(DataTable productosComprados, string CodFact, Cobro c, Cliente cl)
        {
            ...
            string PaginaHTML_Texto = Resources.Plantilla1.ToString();
            ...
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@CODPRODUCTO", LanguageManager.ObtenerInstancia().ObtenerTexto("dgv.CodProducto"));
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@PRODUCTO", LanguageManager.ObtenerInstancia().ObtenerTexto("dgv.Nombre"));
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@TIPO", LanguageManager.ObtenerInstancia().ObtenerTexto("dgv.Tipo"));
            ...
            if (savefile.ShowDialog() == DialogResult.OK)
            {
                using (FileStream stream = new FileStream(savefile.FileName, FileMode.Create))
                {
                    ...
                    iTextSharp.text.Image img = iTextSharp.text.Image.GetInstance(Resources.Cafeccino, System.Drawing.Imaging.ImageFormat.Png);
        ...
        public static void ReporteCompra(DataTable productosComprados, string CodOrden, OrdenCompra orden, Proveedor prov)
        {
            ...
            string PaginaHTML_Texto = Resources.ReporteOrdenCompra.ToString();
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@FECHA", DateTime.Now.ToString("dd/MM/yyyy"));
        ...
        public static void ReporteEvento(int filasDGV, DataTable dtEvento, DataTable dtUsuario)
        {
            ...
            else
            {
                try
                {
                    ...
                    string PaginaHTML_Texto = Resources.ReporteEvento1.ToString();
                    PaginaHTML_Texto = PaginaHTML_Texto.Replace("@FECHA", DateTime.Now.ToString("dd/MM/yyyy"));
        ...
        {
            SaveFileDialog savefile = new SaveFileDialog();
            savefile.FileName = string.Format("Recepcion de compras {0}.pdf", DateTime.Now.ToString("ddMMyyyyHHmmss"));

            string PaginaHTML_Texto = Resources.ReporteRecepcion.ToString();
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@FECHA", DateTime.Now.ToString("dd/MM/yyyy"));
        ...
        public static void ReporteSolicitud(DataTable productosSolicitados, string CodSolicitud, SolicitudCotizacion solicitud, Proveedor prov)
        {
            ...
            string PaginaHTML_Texto = Resources.ReporteSolicitudCotizacion.ToString();
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@FECHA", DateTime.Now.ToString("dd/MM/yyyy"));
        ...
        public static void ReporteInteligente(DataTable dt, string NombreReporte)
        {
            ...
            string PaginaHTML_Texto = Resources.ReporteInteligente.ToString();
            PaginaHTML_Texto = PaginaHTML_Texto.Replace("@FECHA", DateTime.Now.ToString("dd/MM/yyyy"));
